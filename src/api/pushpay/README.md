# pushpay Ingestion — Out of Scope for This Delivery

This directory is scaffolded to match the target repository structure.
Webhook ingestion for pushpay is not implemented in this delivery, which
...
'pushpay' so downstream analytics can trace data provenance back to the
